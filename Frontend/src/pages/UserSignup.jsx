    ...
    <>
      <form onSubmit={submitHandler}>
        <div className='flex flex-col item-center justify-center m-3 w-90 mx-auto gap-5 md:flex md:flex-col md:mt-10 md:item-center md:justify-center md:w-1/3 md:gap-5'>
          ...
          <p className='text-center mx-6 text-[9px] mt-30 md:mt-15 md:text-[12px]'>By proceeding, you confirm to get calls, Whatsapp or SMS messages, including by automated means, from Urbik ans its affiliates to the number provided.</p>
        </div>
      </form>
    </>
  )
