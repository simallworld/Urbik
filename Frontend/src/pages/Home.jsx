        ...
        <div className="h-screen relative overflow-hidden">
            ...
            <div className="flex flex-col justify-end absolute h-screen top-0 w-full">
                <div className="h-[30%] p-6 bg-white relative">
                    <h5 ref={panelCloseRef} onClick={() => { setPanelOpen(false) }} className="absolute opacity-0 top-6 right-8 text-2xl cursor-pointer"><i className="ri-arrow-down-wide-line"></i></h5>
                    ...
                    <form onSubmit={(e) => { submitHandler(e) }}>
                        ...
                        <input
                            ...
                            type="text"
                            onClick={() => { setPanelOpen(true); setFocused('pickup') }}
                            value={pickup}
                        ...
                        <input
                            ...
                            type="text"
                            onClick={() => { setPanelOpen(true); setFocused('destination') }}
                            value={destination}
                            onChange={handleDestinationChange}
                            placeholder="Enter your destination"
                        />
                    </form>
                    <button onClick={findTrip} className='w-full bg-black text-white py-2 rounded-lg mt-5'>Find trip</button>
                </div>
            ...
            <div ref={confirmRidePanelRef} className="fixed z-10 bottom-0 bg-white px-3 py-6 pt-12 w-full translate-y-full">
                ...
                <ConfirmRide passenger={user} createRide={createRide} pickup={pickup} destination={destination} fare={fare} vehicleType={vehicleType} setConfirmRidePanel={setConfirmRidePanel} setVehicleFound={setVehicleFound} />
            </div>
