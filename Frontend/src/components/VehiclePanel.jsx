...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            <div onClick={() => { props.setconfirmRidePanel(true); props.setVehicleType("car") }} className="flex border-3 border-white active:border-black w-full mb-2 p-3 items-center justify-between rounded-lg">
            ...
            <div onClick={() => { props.setconfirmRidePanel(true); props.setVehicleType("bike") }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
            ...
            <div onClick={() => { props.setconfirmRidePanel(true); props.setVehicleType("auto") }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
            ...
            <div onClick={() => { props.setconfirmRidePanel(true); props.setVehicleType("rickshaw") }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
                ...
                <div className="w-1/2">
                    ...
                    <p className="font-normal text-sm text-gray-600">Affordable riksha rides</p>
                </div>
                <h2 className="text-xl font-bold">₹{props.fare.rikshaw}</h2>
            </div>
        </div>
    )
}
