...
const VehiclePanel = (props) => {
    return (
        <div>
            ...
            <h3 className="text-xl mb-2 font-semibold">Select vehicle</h3>
            <div onClick={() => { props.setconfirmRidePanel(true) }} className="flex border-3 border-white active:border-black w-full mb-2 p-3 items-center justify-between rounded-lg">
                ...
                <h2 className="text-xl font-bold">₹483</h2>
            </div>

            <div onClick={() => { props.setconfirmRidePanel(true) }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
                ...
                <h2 className="text-xl font-bold">₹73</h2>
            </div>
            ...
            <div onClick={() => { props.setconfirmRidePanel(true) }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
                ...
                <h2 className="text-xl font-bold">₹254</h2>
            </div>
            ...
            <div onClick={() => { props.setconfirmRidePanel(true) }} className="flex w-full mb-2 p-3 items-center justify-between rounded-lg border-3 border-white active:border-black">
                ...
                <h2 className="text-xl font-bold">₹46</h2>
            </div>
        </div>
    )
}
